      ...
      <section className="pt-24 sm:pt-32 pb-10 sm:pb-16 px-4 bg-gradient-to-br from-primary/5 via-background to-accent/5">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6">News & Updates</h1>
              ...
              >
                <CardContent className="p-6 sm:p-8">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4 gap-2">
                    <span className="inline-block self-start px-3 py-1 text-xs sm:text-sm font-semibold text-accent bg-accent/10 rounded-full">
                      {item.category}
                    </span>
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold mb-3 group-hover:text-accent transition-colors">
                    {item.title}
                  </h2>
                  <p className="text-sm sm:text-base text-muted-foreground mb-4 leading-relaxed">{item.excerpt}</p>
